<script lang="ts">
  import { EventType } from '@fullview/rrweb';
  import type { Replayer } from '@fullview/rrweb';
  import type { playerMetaData } from '@fullview/rrweb-types';
  import type {
    PlayerMachineState,
    SpeedMachineState,
  } from '@fullview/rrweb/typings/replay/machine';
  import {
    onMount,
    onDestroy,
